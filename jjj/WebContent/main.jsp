...
<body>
					...
					<div class="center_container_search_form">
						<form>
							<div class="icon_button">
								<input id="center_container_button" type="search"
									placeholder="찾으시는 유튜버를 검색해주세요" autocomplete="off" />
							</div>
						</form>
					</div>
				</div>
		...
		<ul class="advertising_ul">
			<li onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)"><a
				href="https://www.naver.com" target="_blank"><img
					src="img/live.png" alt="생방송">
					<p class="li_p">생방송</p> </a></li>
			<li onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)"><a
				href="#" target="_blank"><img src="img/youtube_review.png"
					alt="유튜브 리뷰">
					<p class="li_p">유튜브 리뷰</p> </a></li>
			<li onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)"><a
				href="#" target="_blank"><img src="img/youtube_contents.png"
					alt="유튜브 콘텐츠">
					<p class="li_p">유튜브 콘텐츠</p> </a></li>
			<li onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)"><a
				href="#" target="_blank"><img src="img/promotional model.png"
					alt="홍보모델">
					<p class="li_p">홍보모델</p> </a></li>
			<li onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)"><a
				href="#" target="_blank"><img src="img/promotional banner.png"
					alt="홍보베너">
					<p class="li_p">홍보베너</p> </a></li>
			<li onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)"><a
				href="#" target="_blank"><img src="img/CF.png" alt="CF">
						...
						<div class="participating_companies_div">
							<ul>
								<li><a href="" target="_blank"><img
										src="img/amazon.png" alt="기업1" onmouseenter="zoomIn(event)"
										onmouseleave="zoomOut(event)"></a></li>
								<li><a href="" target="_blank"><img
										src="img/samsung.png" alt="기업2" onmouseenter="zoomIn(event)"
										onmouseleave="zoomOut(event)"></a></li>
								<li><a href="" target="_blank"><img src="img/lg.png"
										alt="기업3" onmouseenter="zoomIn(event)"
										onmouseleave="zoomOut(event)"></a></li>
								<li><a href="" target="_blank"><img src="img/puma.png"
										alt="기업4" onmouseenter="zoomIn(event)"
										onmouseleave="zoomOut(event)"></a></li>
							</ul>
							<ul>
								<li><a href="" target="_blank"><img src="img/nike.png"
										alt="기업5" onmouseenter="zoomIn(event)"
										onmouseleave="zoomOut(event)"></a></li>
								<li><a href="" target="_blank"><img src="img/prada.png"
										alt="기업6" onmouseenter="zoomIn(event)"
										onmouseleave="zoomOut(event)"></a></li>
								<li><a href="" target="_blank"><img src="img/pepsi.png"
										alt="기업7" onmouseenter="zoomIn(event)"
										onmouseleave="zoomOut(event)"></a></li>
								<li><a href="" target="_blank"><img
										src="img/cocacola.png" alt="기업8" onmouseenter="zoomIn(event)"
										onmouseleave="zoomOut(event)"></a></li>
							</ul>
							<ul>
								<li><a href="" target="_blank"><img
										src="img/aliexpress.png" alt="기업9"
										onmouseenter="zoomIn(event)" onmouseleave="zoomOut(event)"></a></li>
								<li><a href="" target="_blank"><img src="img/sony.png"
										alt="기업10" onmouseenter="zoomIn(event)"
										onmouseleave="zoomOut(event)"></a></li>
								<li><a href="" target="_blank"><img src="img/kia.png"
										alt="기업11" onmouseenter="zoomIn(event)"
										onmouseleave="zoomOut(event)"></a></li>
								<li><a href="" target="_blank"><img
										src="img/hyundai.png" alt="기업12" onmouseenter="zoomIn(event)"
										onmouseleave="zoomOut(event)"></a></li>
							</ul>
						</div>
					</div>
	...
	<div class="img_info_main">
		...
		<div class="img_info02">
			<a href="adstore.html" target="_blank"><img
				src="img/main_baro.png" alt=""></a>
		</div>
	</div>
